Customer story photos live here.
...
Selection guide
- `cover`
  Best wide photo for the first image.
- `01`, `02`, `03`
  General gallery photos.
- `detail`
  Gear, food, tent setup or close-up mood shots.
- `group`
  People and memory photos.
- `night`
  Campfire, lighting or night atmosphere photos.

If you are not sure where a file should go, drop it into `_incoming/` first.
