...
export const campLifestyleItems: CatalogItem[] = [
  ...
  {
    title: "Finel N7 Carbon Adventure Light",
    day1: "RM59",
    day2: "RM109",
    day3: "RM149",
...
export const featuredPicks: FeaturedPick[] = [
  ...
  },
  {
    ...
    route: "/rent-it/camp-lifestyle-series",
    price: "From RM59 / day",
    description: "Full carbon adventure light for premium camp glow, setup photos and night movement.",
  ...
  },
  {
    ...
    route: "/rent-it/camp-lifestyle-series",
    price: "From RM29 / day",
    description: "Long standby and far connection support for group camps, convoys and campsite coordination.",
